    ...
    $('<input type="text">').css({border:'1px solid #ccc',width:'80%',height:'20px'})
                        ...
                        if(event.keyCode == 13)
                        {
                         ...
                         //   $(this).prev('span').show().text($(this).attr("value"));
                            ...
                            $.get('/ajax/ajax_col/?act=ajax_col&ajax=1',{id:s_id,column:s_name,value:$(this).val()},function(data){
                                if(data === 'false')
                                {
                     ...
                     //   {
                      ...
                      //  }
                        ...
                        $(this).prev('span').show().text($(this).attr('value'));
                        $.get('/ajax/ajax_col/?act=ajax_col&ajax=1',{id:s_id,column:s_name,value:$(this).attr('value')},function(data){
                            if(data === 'false')
                                {
                                    alert(lang.name_exist);
                                    $('span[fieldname="'+s_name+'"][fieldid="'+s_id+'"]').text(s_value);
