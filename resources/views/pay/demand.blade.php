        ...
        <div class="container">
            ...
            <br>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4"><h1>{{$showtitle}}</h1></div>
                    <div class="col-md-2"><hr></div>
                    <div class="col-md-2"> </div>
                </div>
                <div class="row">
                ...
                <div class="row" style="border: 1px solid #dcdcdc;width: 960px;margin: 0 auto;overflow: hidden;">
                        ...
                        <td align="left">
                            <table id="mytable" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="row">  <span class="font_price order_money" >{{ $winprice }}</span>元  </td>
                                    <td class="row">   <span class="font_price order_money" >  {{$demand->deposit }}元</td>
                                    <td class="row">   <span class="font_price order_money" >  {{ $lastPrice }} 元</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                ...
                <div class="col-md-11 text-left" style="margin-top: 20px;padding-left: 80px;height: 64px;
                        line-height: 64px;background: #F7F7F7;margin-left: 20px;font-weight: bold;font-size: 12px;
                        font-family:'Microsoft YaHei';">
                    <span>应付金额</span><span style="color: #FF0000">{{ $lastPrice }}</span>  <span>元</span>
                </div>
