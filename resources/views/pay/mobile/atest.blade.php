        ...
        <div id="body" style="clear:left">
            <dl class="content">
                ...
                <dd>
                    ...
                    <input size="30" name="WIDout_trade_no" value="201508017001" />
                        <span>商户网站订单系统中唯一订单号，必填</span>
                </dd>
                <dt>订单名称：</dt>
                <dd>
                    <span class="null-star">*</span>
                    <input size="30" name="WIDsubject" value="集成测试" />
                        <span>必填</span>
                </dd>
                <dt>付款金额：</dt>
                <dd>
                ...
                <dd>
                    <span class="null-star">*</span>
                    <input size="30" name="WIDshow_url" value="http://jg51.game0635.com/show.php?id=1" />
                        <span>必填，需以http://开头的完整路径，例如：http://www.商户网址.com/myorder.html</span>
                </dd>
                <dt>订单描述：</dt>
                <dd>
                    <span class="null-star">*</span>
